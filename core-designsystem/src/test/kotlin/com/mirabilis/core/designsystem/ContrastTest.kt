...
class ContrastTest {
    ...
    fun `debug print all contrast ratios`() {
        ...
        println("onPrimaryContainer on primaryContainer: ${contrastRatio(light.onPrimaryContainer, light.primaryContainer)}")
        println("onSecondary on secondary: ${contrastRatio(light.onSecondary, light.secondary)}")
        println("onSecondaryContainer on secondaryContainer: ${contrastRatio(light.onSecondaryContainer, light.secondaryContainer)}")
        println("onTertiary on tertiary: ${contrastRatio(light.onTertiary, light.tertiary)}")
        println("onTertiaryContainer on tertiaryContainer: ${contrastRatio(light.onTertiaryContainer, light.tertiaryContainer)}")
        println("onError on error: ${contrastRatio(light.onError, light.error)}")
        println("onErrorContainer on errorContainer: ${contrastRatio(light.onErrorContainer, light.errorContainer)}")
        ...
        println("onSurfaceVariant on surfaceVariant: ${contrastRatio(light.onSurfaceVariant, light.surfaceVariant)}")
        println("inverseOnSurface on inverseSurface: ${contrastRatio(light.inverseOnSurface, light.inverseSurface)}")
        println("=== LIGHT UI ===")
        println("inversePrimary on inverseSurface: ${contrastRatio(light.inversePrimary, light.inverseSurface)}")
        ...
        println("onPrimaryContainer on primaryContainer: ${contrastRatio(dark.onPrimaryContainer, dark.primaryContainer)}")
        println("onSecondary on secondary: ${contrastRatio(dark.onSecondary, dark.secondary)}")
        println("onSecondaryContainer on secondaryContainer: ${contrastRatio(dark.onSecondaryContainer, dark.secondaryContainer)}")
        println("onTertiary on tertiary: ${contrastRatio(dark.onTertiary, dark.tertiary)}")
        println("onTertiaryContainer on tertiaryContainer: ${contrastRatio(dark.onTertiaryContainer, dark.tertiaryContainer)}")
        println("onError on error: ${contrastRatio(dark.onError, dark.error)}")
        println("onErrorContainer on errorContainer: ${contrastRatio(dark.onErrorContainer, dark.errorContainer)}")
        ...
        println("onSurfaceVariant on surfaceVariant: ${contrastRatio(dark.onSurfaceVariant, dark.surfaceVariant)}")
        println("inverseOnSurface on inverseSurface: ${contrastRatio(dark.inverseOnSurface, dark.inverseSurface)}")
        println("=== DARK UI ===")
        println("inversePrimary on inverseSurface: ${contrastRatio(dark.inversePrimary, dark.inverseSurface)}")

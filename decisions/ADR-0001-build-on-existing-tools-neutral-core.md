...
- **Related:** [Vision & Architecture](../docs/00-vision-and-architecture.md), [ADR-0002](ADR-0002-adopt-spec-kit-as-sdd-engine.md) (Spec Kit adoption), a future ADR (knowledge-graph representation — to be created)
